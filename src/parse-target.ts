...
let parsers: Array<[string, Function | "LABEL"]> = [
    ...
    [",reg ← (make-stack)", InstrSetMakeStack],
    [",reg ← (stack-empty? ,reg)", InstrSetIsStackEmpty],
    [",reg ← (,reg!pop)", InstrSetStackPop],
    ["(,reg!push ,reg)", InstrStackPush],
    [",reg ← ,reg", InstrSetReg],
    [",lab", "LABEL"],
];
